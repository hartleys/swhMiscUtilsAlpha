...
try:
   for line in inf:
      if len(line) == 1:
         ...
         eprint("gtColumnList: "+",".join(fmtCols));
         eprint("PRESET gtColumnList: "+str(presetFmtCols));
         isOnHeader = False;
         ...
         if keepGT:
            if tableGT :
               ...
               if emitOnlySimpleHet or emitOnlyNonref or emitAnyNonref or filterGeno or emitOnlySamplesOnList:
                  out.write("\tFORMAT");
